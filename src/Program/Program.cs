...
public class Program
{
    ...
    public static void Main()
    {
        ...
        // Creo el nuevo bot con el token que cargué
        bot = new TelegramBotClient(token);

        // Creo una nueva instancia de la API de ubicacion
        client = new LocationApiClient();

        // Empiezo a crear mi cadena de handlers anidados
        // Cada Handler se encargue de procesar un mensaje en específico
        // Para ésto creo varios handlers que están anidados entre sí usando el patrón Chain of Responsibility

        firstHandler = new AutenticadorHandler(null);
...
//         public static void Main()
//         {
//             IHandler handler = new AutenticadorHandler(null);
